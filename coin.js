...
function coinToss() {
  ...
  if (x === 0) {
    coin.innerHTML = '<img class="heads animate-coin" src="C:\Users\HP\Documents\first JS/British_fifty_pence_coin_2015_obverse.png"/>';
    ...
    coin.innerHTML = '<img class="tails animate-coin" src="C:\Users\HP\Documents\first JS/British_fifty_pence_coin_2015_reverse.png"/>';
     tails += 1;
